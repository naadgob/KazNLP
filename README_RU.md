...
Полная история и цифры для жюри: [`STORY_RU.md`](STORY_RU.md) · веб-версия [`web/story.html`](web/story.html) (генерация: `python scripts/build_story_landing.py`).

---

## Ключевые числа (канон защиты)

Источник: `main.ipynb` (cells 45, 173, 237, 255, 268), `docs/capstone/Final_Report_RU.md`, `data/processed/metrics_tone_test.json`.
...
Порт по умолчанию 8000 (если занят — следующий свободный). См. [`labeling_service/README_RU.md`](labeling_service/README_RU.md).
...
```
KazNLP/
├── main.ipynb                      # основной пайплайн (274 ячейки)
...
Baseline ladder на одном test n=461: §10 (cells 265–275) — FastText → HeLI raw/neutral/windows-grid → char-3gram NB → Lingua → XLM-R.
...
| Файл | Содержание |
|------|------------|
| [`STORY_RU.md`](STORY_RU.md) | Полный нарратив, таблица источников |
| [`web/story.html`](web/story.html) | То же для жюри в браузере |
| [`docs/README_RU.md`](docs/README_RU.md) | Индекс всей документации |
| [`docs/capstone/Final_Report_RU.md`](docs/capstone/Final_Report_RU.md) | Финальный отчёт |
| [`docs/tone_dataset_overview.md`](docs/tone_dataset_overview.md) | Gold tone, synthetic, QC |
| [`docs/capstone/PRESENTATION_OUTLINE_RU.md`](docs/capstone/PRESENTATION_OUTLINE_RU.md) | Структура презентации |
| [`docs/capstone/CAPSTONE_AUDIT_RU.md`](docs/capstone/CAPSTONE_AUDIT_RU.md) | Чеклист SIC |
| [`docs/capstone/presentation.pptx`](docs/capstone/presentation.pptx) | Презентация SIC (единственный pptx) |
| [`labeling_service/README_RU.md`](labeling_service/README_RU.md) | Labeler setup |
| [`web/README_RU.md`](web/README_RU.md) | Demo site |
